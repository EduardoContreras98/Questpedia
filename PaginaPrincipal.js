const defaultInput = document.getElementById("HacerPregunta");
const element = document.querySelector(".pagination ul");
let totalPages = 20;
let page = 10;

var VoteD = document.querySelector(".votev");
...
document.getElementById("askQ").addEventListener("click", AskQuest);
...
function  increment(){
  ...
  alert("+1!");
  foo++;
  document.getElementById("valueV1").innerHTML = foo;
