...
document.getElementById("youtubeirl").addEventListener("click", Irlsliode);
document.getElementById("custom-btn1").addEventListener("click", DefaultBtnActive1);

document.getElementById("go-youtube").addEventListener("click", vidBtnActive);
document.getElementById("videoirl").addEventListener("click", DefaultBtnActiveVid);
